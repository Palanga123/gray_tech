    ...
    return (
        <>
            ...
            <footer className="bottom-0 text-black w-full bg-gray-50">
                ...
                <p className="text-center font-semibold text-xs text-white py-4 bg-[#1352cf]">&copy; {new Date().getFullYear()} All Rights Reserved. Designed by <a href="https://palangageorgenkobi.onrender.com" className="underline underline-offset-4">Palanga George Nkobi</a></p>
            </footer>
        </>
    );
};
